...
| [opentelemetry-instrumentation-qodercli](./opentelemetry-instrumentation-qodercli/) | Qoder CLI | Hook-based per-turn tracing + transcript JSONL replay (ARMS GenAI semconv) |
